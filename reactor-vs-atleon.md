...
| commits                        | `kafkaSenderResult.correlationMetadata().acknowledge()`                         | `senderResult.correlationMetadata().receiverOffset().commit()`                                                    | **Important:** Using Atleon, every emitted record has acknowledged.                                  |                                                                                                      |
